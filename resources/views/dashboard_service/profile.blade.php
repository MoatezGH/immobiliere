...
{{-- {{ dd("dd") }} --}}
    <div class="user-profile-wrapper">
        <div class="row">
                    ...
                    <div class="user-profile-card">
                        ...
                        <div class="col-lg-12">
                            <div class="post-ad-form">
                                ...
                                @endif
                                <form action="{{ route('updateProfileService') }}" method="POST">
                                    @csrf
                                    <div class="row align-items-center">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ auth()->guard('service_user')->user()->full_name }}" name="full_name">
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>E-mail</label>
                                                <input type="text" class="form-control"
                                                    value="{{ auth()->guard('service_user')->user()->email }}" placeholder="Email" name="email">
                                            </div>
                                            @if ($errors->has('email'))
                                                <p class="text-danger">
                                                    {{ $errors->first('email') }}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="{{ auth()->guard('service_user')->user()->phone }}"
                                                    placeholder="+216 55 000 000" name="phone" onkeypress="return isNumberKey(event)">
                                            </div>
                                            @if ($errors->has('phone'))
                                                <p class="text-danger">
                                                    {{ $errors->first('phone') }}
                                                ...
                                                <select class="select" name="city_id" id="citySelect">
                                                    ...
                                                    @foreach ($cities as $city)
                                                        <option value="{{ $city->id }}"
                                                            {{ auth()->guard('service_user')->user()->country_id == $city->id ? 'selected' : '' }}>
                                                            {{ $city->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group" id="area_div">
                                                ...
                                                <select class="select" name="area_id" id="areaSelect">
                                                    ...
                                                    @foreach ($areas as $area)
                                                        <option
                                                            {{ auth()->guard('service_user')->user()->city_id == $area->id ? 'selected' : '' }}
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="address"
                                                    value="{{ auth()->guard('service_user')->user()->address }}" placeholder="votre adresse">
                                            </div>
                                        ...
                                        {{-- <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ auth()->guard('service_user')->user()->fb_link ?? '' }}">
                                            </div>
           ...
           @include('dashboard_service.includes.change_password_account')
<form action="{{ route('updateProfileService') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-lg-12">
                                ...
                                <form action="#">
                                    <div class="form-group">
                                        ...
                                        <div class="store-logo-preview">
                                                ...
                                                {{-- {{ dd('eeeeeeeee') }} --}}
                                                <img src="{{ asset($user->logo ? 'uploads/user_service_logos/' . $user->logo : 'assets/img/store/01.jpg') }}"
                                                    alt="Store Logo">

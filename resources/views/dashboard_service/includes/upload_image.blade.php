...
{{-- {{ dd($service->mainPicture->picture_path) }} --}}
...
<div class="col-lg-12">
    <div class="form-group">
        <div class="product-upload-wrapper">
            <div class="product-img-upload main_pic">
                <span onclick="open_main()"><i class="far fa-images"></i> Télécharger image principal de service</span>
            </div>
    ...
    <div class="col-lg-12" id="mainPicturePreview">
        ...
        <img id="mainPicturePreviewImg"
            src="{{ asset($service->mainPicture ? 'uploads/service/main_picture/' . $service->mainPicture->picture_path : 'assets/img/product/01.jpg') }}"
...
<div class="col-lg-12">
    <div class="form-group">
        <div class="product-upload-wrapper">
            <div class="product-img-upload">
                <span onclick="open_multiple()"><i class="far fa-images"></i> Télécharger images de service</span>
            </div>
    ...
    <div class="image-preview" id="multipleImagesPreview">
        @foreach ($service->pictures as $item)
            {{-- {{ dd($item) }} --}}
            <div class="image-preview-item" id="p-{{ $item->id }}">
                <img src="{{ asset('uploads/service/multi_images/' . $item->picture_path) }}" alt="" >
                <br>
                <div class="d-flex justify-space-between" style="justify-content: space-between;">


                    <button type="button"  data-url="{{ route('delete_image_service', $item->id) }}"

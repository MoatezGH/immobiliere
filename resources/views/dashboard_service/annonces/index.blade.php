    ...
    <div class="user-profile-wrapper">
        <div class="user-profile-card profile-ad">
            <div class="user-profile-card-header">
                <h4 class="user-profile-card-title">Mes services</h4>
                <form action="{{ route('index_service') }}" method="GET">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="table-ad-info">
                                                <a href="#">
                                                    ...
                                                    <img src="{{ asset($item->mainPicture ? 'uploads/service/main_picture/' . $item->mainPicture->picture_path : 'assets/img/product/01.jpg') }}"
                                        ...
                                        <td>
                                            ...
                                            @if ($item->remonter != true)
                                                <form action="{{ route('service.remonter', $item->id) }}" method="POST"
                                            ...
                                            <a href="{{ route('update_service', $item->id) }}"
                                                class="btn btn-outline-secondary btn-sm rounded-2" data-bs-toggle="tooltip"
                                                aria-label="Edit" data-bs-original-title="Modifier">
                                                <i class="far fa-pen"></i>
                                            </a>

                                            <a href="{{ route('show_update_images_service', $item->id) }}"
                                                class="btn btn-outline-success btn-sm rounded-2" data-bs-toggle="tooltip"
                                                aria-label="Edit" data-bs-original-title="Modifier images">
                                            ...
                                            <a href="#"
                                                ...
                                                onclick="event.preventDefault(); if(confirm('Êtes-vous sûr de vouloir supprimer ce service?'))  { document.getElementById('delete-service-form-{{ $item->id }}').submit(); }"
                                                data-bs-original-title="Supprimer">
                                                <i class="far fa-trash-can"></i>
                                            </a>

                                            <form display="none" id="delete-service-form-{{ $item->id }}"

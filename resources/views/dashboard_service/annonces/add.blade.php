...
@section('content')
    ...
    <div class="user-profile-wrapper">
        <div class="user-profile-card">
            ...
            @endif
            <h4 class="user-profile-card-title">Publier votre service</h4>
            <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('service') is-invalid @enderror"
                                        placeholder="Entrez le service" name="service" value="{{ old('service') }}">
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="work_zone" value="{{ old('work_zone') }}" class="form-control">
                                </div>
                            </div>
                            <hr>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" name="type_annonceur" value="0" type="radio"
                                            role="switch" id="type_annonceur-1" checked="">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" name="type_annonceur" value="1" type="radio"
                                            role="switch" id="type_annonceur-2" checked="">
                                ...
                                <div class="form-group">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" name="type_product" value="1" type="radio"
                                            role="switch" id="type_product-2" checked="">
                                        <label class="form-check-label" for="type_product-2">Offre de service</label>


                                    </div>
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" name="type_product" value="2" type="radio"
                                            role="switch" id="type_product-3" checked="">
                                    ...
                                    @foreach ($type_payement as $item)
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" name="paiement_type"
                                                ...
                                                id="paiement_type-{{ $item->id }}" checked="">
...
<hr>
                            ...
                            <div class="col-lg-12 my-4 align-items-center d-flex">
                                <button style="margin-right: 6px" type="submit" class="theme-btn mr-2">Publier & ajouter
                                    des images</button>

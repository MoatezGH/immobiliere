...
{{-- {{ dd($partenaire) }} --}}
    ...
    <div class="user-profile-wrapper">
        <div class="user-profile-card">
            ...
            @endif
            <h4 class="user-profile-card-title">Modifier slider</h4>
            <div class="col-lg-12">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                        placeholder="Entrez le titre" name="title" value="{{ $partenaire->description }}"
                                        maxlength="34">
                                </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-12" id="mainPicturePreview" >
                                    <img id="mainPicturePreviewImg" src="{{asset("uploads/partenaire/".$partenaire->image_url)}}" alt="Main Picture Preview"
                                        style="max-width: 100%; max-height: 300px;">
                                </div>
                                <div class="col-6 mt-4">
                                <div class="form-check">
                                    <input class="form-check-input" name="publish_now" type="checkbox" value="1" {{ $partenaire->status == 1 ? 'checked' : '' }}
                                        id="publish_now">

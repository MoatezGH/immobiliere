        ...
        <div class="user-profile-card">
            ...
            <div class="col-lg-12">
                <div class="post-ad-form">
                    ...
                    <form action="{{ route('update_admin_property_promoteur', $property[0]) }}" method="POST"
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    {{-- <select name="etage" class="select">
                                        <option value="rdc" {{ isset($property[0]['etage']) && $property[0]['etage'] === "immediate" ? 'selected' : '' }}>RDC</option>
                                        <option value="1" {{ isset($property[0]['etage']) && $property[0]['etage'] === "immediate" ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ isset($property[0]['etage']) && $property[0]['etage'] === "immediate" ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ isset($property[0]['etage']) && $property[0]['etage'] === "immediate" ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ isset($property[0]['etage']) && $property[0]['etage'] === "immediate" ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ isset($property[0]['etage']) && $property[0]['etage'] === "immediate" ? 'selected' : '' }}>5</option>
                                        <option value="6" {{ isset($property[0]['etage']) && $property[0]['etage'] === "immediate" ? 'selected' : '' }}>6</option>
                                        <option value="7" {{ isset($property[0]['etage']) && $property[0]['etage'] === "immediate" ? 'selected' : '' }}>7</option>
                                        <option value="8" {{ isset($property[0]['etage']) && $property[0]['etage'] === "immediate" ? 'selected' : '' }}>8</option>
                                    </select> --}}
                                </div>
                            </div>

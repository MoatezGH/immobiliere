                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                        placeholder="Entrez le titre" name="title" value="{{ $slider->description }}"
                                        maxlength="34">
                                </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-12" id="mainPicturePreview" ">
                                    <img id="mainPicturePreviewImg" src="{{asset("uploads/sliders/".$slider->alt)}}" alt="Main Picture Preview"

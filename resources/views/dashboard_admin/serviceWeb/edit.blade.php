...
{{-- {{ dd($slider) }} --}}
    ...
    <div class="user-profile-wrapper">
        <div class="user-profile-card">
            ...
            @endif
            <h4 class="user-profile-card-title">Modifier Service</h4>
            <div class="col-lg-12">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                        placeholder="Entrez le titre" name="title" value="{{ $slider->title }}"
                                        maxlength="34">
                                </div>
          ...
          placeholder="Entrez le titre" name="description">{{ $slider->description }}</textarea>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-12" id="mainPicturePreview" >
                                    <img id="mainPicturePreviewImg" src="{{asset("uploads/serviceWeb/".$slider->imageUrl)}}" alt="Main Picture Preview"
                                        style="max-width: 100%; max-height: 300px;">
                                </div>
                                <div class="col-6 mt-4">
                                <div class="form-check">
                                    <input class="form-check-input" name="publish_now" type="checkbox" value="1" {{ $slider->active == 1 ? 'checked' : '' }}
                                        id="publish_now">

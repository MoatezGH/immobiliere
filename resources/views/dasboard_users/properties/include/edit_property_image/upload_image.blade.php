...
{{-- <div class="col-lg-12">
    <!-- Input for main picture -->
    <div class="form-group">
        <label for="mainPicture">Main Picture</label>
        <div class="custom-file">
            <input type="file" class="custom-file-input" id="mainPictureInput" onchange="previewMainPicture(event)">
            <label class="custom-file-label" for="mainPictureInput">Choose file</label>
        </div>
        <div class="col-lg-12" id="mainPicturePreview" style="display: none;">
            <img id="mainPicturePreviewImg" src="#" alt="Main Picture Preview" style="max-width: 100%; max-height: 300px;">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="custom-file">
            <input type="file" class="custom-file-input" id="multipleImagesInput" multiple onchange="previewMultipleImages(event)">
            <label class="custom-file-label" for="multipleImagesInput">Choose files</label>
        </div>
        <div class="col-lg-12" id="multipleImagesPreview" style="display: none;"></div>
    </div>
</div> --}}
...
<div class="col-lg-12">
    ...
    <div class="col-lg-12" id="mainPicturePreview">
        ...
        <img id="mainPicturePreviewImg"
            src="{{ asset($property[0]->main_picture ? 'uploads/main_picture/images/properties/' . $property[0]->main_picture->alt : 'assets/img/product/01.jpg') }}"
    ...
    <div class="form-group">
        <div class="product-upload-wrapper">
            ...
            <input type="file" class="product-img-file" name="photos_multiple[]" multiple
                onchange="previewMultipleImages(event)" id="open_multiple">
        </div>
    </div>
    <div class="image-preview" id="multipleImagesPreview">
        @foreach ($property[0]->pictures as $item)
            ...
            <div class="image-preview-item" id="p-{{ $item->id }}">
                <img src="{{ asset('uploads/property_photo/' . $item->alt) }}" alt="" title={{ $item->alt }}>
                <br>
                <div class="d-flex justify-space-between" style="justify-content: space-between;">


                    <button type="button"  data-url="{{ route('delete_image', $item->id) }}"

...
<div class="col-lg-12">
    ...
    <div class="col-lg-12" id="mainPicturePreview">
        ...
        <img id="mainPicturePreviewImg"
            src="{{ asset($property[0]->getFirstImageOrDefault() ? 'uploads/promoteur_property/' . $property[0]->getFirstImageOrDefault() : 'assets/img/product/01.jpg') }}"
        ...
        @if ( count($property[0]->images) > 0)
            ...
            @if($item->is_main == 1) @continue @endif
                ...
                <div class="image-preview-item" id="p-{{ $item->id }}">
                    <img src="{{ asset('uploads/promoteur_property/' . $item->title) }}" alt=""
                        title={{ $item->title }}>
                    <br>
                    <div class="d-flex justify-space-between" style="justify-content: space-between;">


                        <a href="javascript:void(0)" data-url="{{ route('delete_image_promoteur', $item->id) }}"

...
{{-- {{ dd($featuresExist) }} --}}
        <div class="user-profile-card profile-ad">
            ...
            <div class="user-profile-card-header mt-3">
                ...
                <form action="{{ route('admin_services') }}" method="GET">
                    {{-- @csrf --}}
                                ...
                                @foreach ($services as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin_update_service', $item->id) }}"
                                            ...
                                            <a href="{{ route('services.admin.info', $item->id) }}"
                                            ...
                                            <form display="none" id="delete-property-form-{{ $item->id }}"
                                                action="{{ route('services.destroy.admin', $item->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')

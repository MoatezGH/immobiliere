                    ...
                    <div class="col-md-3">
                        <div class="product-item">
                            <div class="product-img">
                                ...
                                <img src="{{ asset($property->mainPicture ? 'uploads/classified/main_picture/' . $property->mainPicture->picture_path : 'assets/img/product/01.jpg') }}"
                                    style="
                        ...
                        <div class="col-md-3">
                            <div class="product-item">
                                <div class="product-img">
                                    ...
                                    <img src="{{ asset('uploads/classified/multi_images/' . $item->picture_path) }} "
                                        style="
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="statusModalLabel">Changer le statut de la débarras</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <!-- Add your status options here -->
                    <form method="POST" action="{{ route('classifieds.update.status', ['id' => $property->id]) }}">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">

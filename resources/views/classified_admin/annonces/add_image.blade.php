        ...
        <div class="user-profile-card">
            ...
            <div class="col-lg-12">
                <div class="post-ad-form">
                    <form action="{{ route('admin_add_images_classified',$classified->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @include('dasboard_users.properties.include.upload_image')

                        <div class="image-preview" id="imagePreview"></div>
                        <div class="col-lg-12 my-4 align-items-center d-flex">
                            <button style="margin-right: 6px" type="submit" class="theme-btn mr-2">Publier </button>
